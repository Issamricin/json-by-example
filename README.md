...
1. a_example.py: This module contains a sample of encoding and decoding json strings into python dictionaries, 
and from python dictionaries back to json strings.
2. b_example.py: This module is similar to the previous one but it focuses more on the printing,
...
6. f_example.py: This module is the first exercise that you have to solve. The data contains both complex and datetime data types,
you need to create a custom encoder and decoder for this data.
7. g_example.py: This module is also an exercise with different data types (data,timedelta,timezone) that needs a different way of
